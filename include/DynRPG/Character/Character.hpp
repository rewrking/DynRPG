...
struct Character
{
	...
	Direction direction; //!< Direction for moving (see RPG::Direction)
	Facing facing; //!< Direction for facing (see RPG::Facing)
	...
	*/
	...
	Layer layer; //!< %Layer (below/same level as/above hero, see RPG::Layer)
