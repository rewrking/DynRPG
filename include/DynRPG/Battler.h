#ifndef DYNRPG_BATTLER_H
#define DYNRPG_BATTLER_H

#include <DynRPG/Enum/ActionStatus.h>
#include <DynRPG/Enum/ActionType.h>
#include <DynRPG/Enum/Row.h>
...
/*! \brief Used for entities participating in battle, i.e. actors and
	...
	\sa RPG::Monster
*/
class DYNRPG_API Battler // TLcfgUnitItem
{
public:
	void** vTable;
