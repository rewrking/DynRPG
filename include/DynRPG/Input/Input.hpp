#ifndef RPG_INPUT_HPP
#define RPG_INPUT_HPP
...
struct Input
{
	...
	*/
	...
	KeyDown isPressed; //!< Are a combination of keys pressed & released (See RPG::KeyDown)
	KeyModifierDown isShiftCtrlPressed; //!< Are the Shift or Ctrl keys & released (See RPG::KeyDownAlt)
		char _unknown_33A;
		char _unknown_33B;
		int _unknown_33C;
	KeyDown isHeld; //!< Are a combination of keys held (See RPG::KeyDown)
	KeyModifierDown isShiftCtrlHeld; //!< Are the Shift or Ctrl keys held (See RPG::KeyDownAlt)
		char _unknown_342;
		char _unknown_343;
	KeyDown isTapped; //!< Are a combination of keys tapped (See RPG::KeyDown)
	KeyModifierDown isShiftCtrlTapped; //!< Are the Shift or Ctrl keys tapped (See RPG::KeyDownAlt)
		char _unknown_34A;
		char _unknown_34B;
...
*/
static Input*& input = (**reinterpret_cast<Input***>(0x4CDAEC));
}
