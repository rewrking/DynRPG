#ifndef RPG_DB_CLASS_HPP
#define RPG_DB_CLASS_HPP
...
int experience1 = RPG::dbClasses[1]->expPrimary;
	...
	\sa RPG::actors
*/
static NamedCatalogPtr<DBClass*>& dbClasses = (**reinterpret_cast<NamedCatalogPtr<DBClass*>**>(0x4CDD7C));
}

#endif // RPG_DB_CLASS_HPP