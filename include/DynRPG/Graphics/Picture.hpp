#ifndef RPG_PICTURE_HPP
#define RPG_PICTURE_HPP
...
*/
static NamedCatalogPtr<Picture*>& pictures = (**reinterpret_cast<NamedCatalogPtr<Picture*>**>(0x4CDF3C));
}

#endif // RPG_PICTURE_HPP