#ifndef DYNRPG_CONDITION_H
#define DYNRPG_CONDITION_H

#include <DynRPG/Enum/ActionRestriction.h>
#include <DynRPG/Enum/AlterationType.h>
#include <DynRPG/Enum/BaseStatAlteration.h>
