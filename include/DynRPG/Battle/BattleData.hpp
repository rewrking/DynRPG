...
struct BattleData
{
	...
	BattleNavigationLevel navLevel; //!< Which window or action has the focus?
...
std::string backdropName = RPG::battleData->backdropFilename.s_str());
	\endcode
*/
static BattleData*& battleData = (**reinterpret_cast<BattleData***>(0x4CDD38));
}

#endif // RPG_BATTLE_DATA_HPP
