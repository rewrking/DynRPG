#ifndef RPG_MAP_PROPERTIES_HPP
#define RPG_MAP_PROPERTIES_HPP
...
struct MapProperties
{
	...
	MapWrapping wrapping; //!< The wrapping of the map, set via dropdown
	...
	StubPtr charsetGraphics; //!< Not yet implemented. Wtf even is this?
		int _unknown_48;
