...
extern "C"
{
	...
	*/
	...
	/*! @function
		...
		\sa onExit
	*/
	bool DYN_PLUGIN_EXPORT onStartup(char* pluginName);
	...
	*/
	...
	/*! \brief Called before the player loads a game from a savestate
		...
		\sa onLoadGame
	*/
	void DYN_PLUGIN_EXPORT onLoadGame(int id, char* data, int length);
	...
	/*! \brief Called before the player saves a game
		...
		\sa onLoadGame
	*/
	void DYN_PLUGIN_EXPORT onSaveGame(int id, void __cdecl (*savePluginData)(char* data, int length));
	...
	*/
	void DYN_PLUGIN_EXPORT onFrame(RPG::Scene scene);
	...
	/*! \brief Called before an in-game variable is set
		...
		\sa onSetSwitch
	*/
	bool DYN_PLUGIN_EXPORT onSetVariable(int id, int value);
	...
	/*! \brief Called before an in-game variable is read
		...
		\sa onGetSwitch
	*/
	//bool DYN_PLUGIN_EXPORT onGetVariable(int id);
	//! \endcond
	...
	/*! \brief Called before an in-game switch is set
		...
		\sa onSetVariable
	*/
	bool DYN_PLUGIN_EXPORT onSetSwitch(int id, bool value);
	...
	/*! \brief Called before an in-game switch is read
		...
		\sa onSetSwitch
	*/
	//bool DYN_PLUGIN_EXPORT onGetSwitch(int id);
	//! \endcond
	...
	/*! \brief Called before an event command is executed
		...
		\sa onComment
	*/
	bool DYN_PLUGIN_EXPORT onEventCommand(RPG::EventScriptLine* scriptLine, RPG::EventScriptData* scriptData, int eventId, int pageId, int lineId, int* nextLineId);
	...
	/*! \brief Called when a "Comment" event command is encountered
		...
		\sa onEventCommand
	*/
	bool DYN_PLUGIN_EXPORT onComment(const char* text, const RPG::ParsedCommentData* parsedData, RPG::EventScriptLine* nextScriptLine, RPG::EventScriptData* scriptData, int eventId, int pageId, int lineId, int* nextLineId);
	...
	/*! \brief Called when the screen is drawn on the game window
		...
		\sa onFrame
	*/
	void DYN_PLUGIN_EXPORT onDrawScreen();
	...
	/*! \brief Called before a picture is drawn
		...
		\sa onPictureDrawn
	*/
	bool DYN_PLUGIN_EXPORT onDrawPicture(RPG::Picture* picture);
	...
	/*! \brief Called after a picture was drawn (or was supposed to be drawn)
		...
		\sa onDrawPicture
	*/
	bool DYN_PLUGIN_EXPORT onPictureDrawn(RPG::Picture* picture);
	...
	/*! \brief Called every frame to check whether an event should be drawn
		...
		\sa onEventDrawn
	*/
	bool DYN_PLUGIN_EXPORT onCheckEventVisibility(RPG::Character* character);
	...
	/*! \brief Called before an event or the hero is drawn
		...
		\sa onEventDrawn
	*/
	bool DYN_PLUGIN_EXPORT onDrawEvent(RPG::Character* character, bool isHero);
	...
	/*! \brief Called after an event or the hero was drawn (or was supposed to
		...
		\sa onDrawEvent
	*/
	bool DYN_PLUGIN_EXPORT onEventDrawn(RPG::Character* character, bool isHero);
	...
	/*! \brief Called before a battler is drawn
		...
		\sa onBattlerDrawn
	*/
	bool DYN_PLUGIN_EXPORT onDrawBattler(RPG::Battler* battler, bool isMonster, int id);
	...
	/*! \brief Called after a battler was drawn (or supposed to be drawn)
		...
		\sa onDrawBattler
	*/
	bool DYN_PLUGIN_EXPORT onBattlerDrawn(RPG::Battler* battler, bool isMonster, int id);
	...
	*/
	bool DYN_PLUGIN_EXPORT onDrawBattleStatusWindow(int x, int selection, bool selActive, bool isTargetSelection, bool isVisible);
	...
	*/
	bool DYN_PLUGIN_EXPORT onBattleStatusWindowDrawn(int x, int selection, bool selActive, bool isTargetSelection, bool isVisible);
	...
	/*! \brief Called before the battle action window is drawn
		...
		\sa onBattleStatusWindowDrawn
	*/
	bool DYN_PLUGIN_EXPORT onDrawBattleActionWindow(int* x, int* y, int selection, bool selActive, bool isVisible);
	...
	/*! \brief Called before a battler's action is executed
		...
		\sa RPG::Action
	*/
	bool DYN_PLUGIN_EXPORT onDoBattlerAction(RPG::Battler* battler, bool firstTry);
	...
	/*! \brief Called after a battler's action is executed
		...
		\sa RPG::Action
	*/
	bool DYN_PLUGIN_EXPORT onBattlerActionDone(RPG::Battler* battler, bool success);
	...
	*/
	bool DYN_PLUGIN_EXPORT onSystemBackgroundDrawn(RECT* rect);
	/** @} */
}
#endif // DYNRPG_STATIC

#endif // RPG_PLUGIN_CALLBACKS_HPP
