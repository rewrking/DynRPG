#ifndef DYNRPG_PICTURE_H
#define DYNRPG_PICTURE_H

#include <DynRPG/Enum/PictureEffect.h>
...
*/
extern DYNRPG_API NamedCatalogPtr<Picture*>& pictures;
}

#endif // DYNRPG_PICTURE_H
